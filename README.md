# GeoIP 简介 [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/asdetycv1zzc/geoip) ![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/asdetycv1zzc/geoip/total?logo=github) ![GitHub Downloads (all assets, latest release)](https://img.shields.io/github/downloads/asdetycv1zzc/geoip/latest/total?logo=github) [![jsdelivr stats](https://data.jsdelivr.com/v1/package/gh/asdetycv1zzc/geoip/badge?style=rounded)](https://www.jsdelivr.com/package/gh/asdetycv1zzc/geoip)
...
本项目默认使用 [MaxMind GeoLite2 Country CSV 数据](https://github.com/asdetycv1zzc/geoip/blob/release/GeoLite2-Country-CSV.zip)生成各个国家和地区的 GeoIP 文件。所有可供使用的国家和地区 geoip 类别（如 `geoip:cn`，两位英文字母表示国家和地区），请查看：[https://www.iban.com/country-codes](https://www.iban.com/country-codes)。
...
本项目发布的所有 GeoIP 文件，请查看 [release 分支](https://github.com/asdetycv1zzc/geoip/tree/release)。以下是部分格式 GeoIP 文件的下载地址：
...
- **geoip.dat**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/geoip.dat](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/geoip.dat)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip.dat](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip.dat)
- **geoip.dat.sha256sum**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/geoip.dat.sha256sum](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/geoip.dat.sha256sum)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip.dat.sha256sum](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip.dat.sha256sum)
- **geoip-only-cn-private.dat**（精简版 GeoIP，只包含 `geoip:cn` 和 `geoip:private`）：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/geoip-only-cn-private.dat](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/geoip-only-cn-private.dat)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip-only-cn-private.dat](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip-only-cn-private.dat)
- **geoip-only-cn-private.dat.sha256sum**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/geoip-only-cn-private.dat.sha256sum](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/geoip-only-cn-private.dat.sha256sum)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip-only-cn-private.dat.sha256sum](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip-only-cn-private.dat.sha256sum)
- **geoip-asn.dat**（精简版 GeoIP，只包含上述新增类别）：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/geoip-asn.dat](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/geoip-asn.dat)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip-asn.dat](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip-asn.dat)
- **geoip-asn.dat.sha256sum**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/geoip-asn.dat.sha256sum](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/geoip-asn.dat.sha256sum)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip-asn.dat.sha256sum](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip-asn.dat.sha256sum)
- **cn.dat**（精简版 GeoIP，只包含 `geoip:cn`）：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/cn.dat](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/cn.dat)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/cn.dat](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/cn.dat)
- **cn.dat.sha256sum**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/cn.dat.sha256sum](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/cn.dat.sha256sum)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/cn.dat.sha256sum](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/cn.dat.sha256sum)
- **private.dat**（精简版 GeoIP，只包含 `geoip:private`）：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/private.dat](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/private.dat)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/private.dat](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/private.dat)
- **private.dat.sha256sum**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/private.dat.sha256sum](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/private.dat.sha256sum)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/private.dat.sha256sum](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/private.dat.sha256sum)
- **所有国家 / 地区 / 新增类别**的 dat 格式文件，请查看本项目 `release` 分支下的 [dat 目录](https://github.com/asdetycv1zzc/geoip/tree/release/dat)。
...
geodata-mode: true
geox-url:
  geoip: "https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/geoip.dat"
```
</details>
...
- **GeoLite2-Country.mmdb**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/GeoLite2-Country.mmdb](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/GeoLite2-Country.mmdb)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/GeoLite2-Country.mmdb](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/GeoLite2-Country.mmdb)
- **GeoLite2-Country.mmdb.sha256sum**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/GeoLite2-Country.mmdb.sha256sum](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/GeoLite2-Country.mmdb.sha256sum)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/GeoLite2-Country.mmdb.sha256sum](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/GeoLite2-Country.mmdb.sha256sum)
...
- **GeoLite2-ASN.mmdb**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/GeoLite2-ASN.mmdb](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/GeoLite2-ASN.mmdb)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/GeoLite2-ASN.mmdb](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/GeoLite2-ASN.mmdb)
- **GeoLite2-ASN.mmdb.sha256sum**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/GeoLite2-ASN.mmdb.sha256sum](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/GeoLite2-ASN.mmdb.sha256sum)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/GeoLite2-ASN.mmdb.sha256sum](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/GeoLite2-ASN.mmdb.sha256sum)
...
- **Country-without-asn.mmdb**（传统版 GeoIP，只包含国家/地区类别，不包含上述新增类别。建议优先使用）：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country-without-asn.mmdb](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country-without-asn.mmdb)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country-without-asn.mmdb](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country-without-asn.mmdb)
- **Country-without-asn.mmdb.sha256sum**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country-without-asn.mmdb.sha256sum](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country-without-asn.mmdb.sha256sum)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country-without-asn.mmdb.sha256sum](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country-without-asn.mmdb.sha256sum)
- **Country.mmdb**（增强版 GeoIP，包含国家/地区类别，以及上述新增类别。但由于 MaxMind mmdb 格式限制，部分国家/地区类别的 IP 地址数据不如上述 **Country-without-asn.mmdb** 准确）：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country.mmdb](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country.mmdb)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country.mmdb](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country.mmdb)
- **Country.mmdb.sha256sum**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country.mmdb.sha256sum](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country.mmdb.sha256sum)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country.mmdb.sha256sum](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country.mmdb.sha256sum)
- **Country-only-cn-private.mmdb**（精简版 GeoIP，只包含 `GEOIP,CN` 和 `GEOIP,PRIVATE`）：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country-only-cn-private.mmdb](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country-only-cn-private.mmdb)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country-only-cn-private.mmdb](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country-only-cn-private.mmdb)
- **Country-only-cn-private.mmdb.sha256sum**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country-only-cn-private.mmdb.sha256sum](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country-only-cn-private.mmdb.sha256sum)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country-only-cn-private.mmdb.sha256sum](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country-only-cn-private.mmdb.sha256sum)
- **Country-asn.mmdb**（精简版 GeoIP，只包含上述新增类别）：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country-asn.mmdb](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country-asn.mmdb)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country-asn.mmdb](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country-asn.mmdb)
- **Country-asn.mmdb.sha256sum**：
  - [https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country-asn.mmdb.sha256sum](https://raw.githubusercontent.com/asdetycv1zzc/geoip/release/Country-asn.mmdb.sha256sum)
  - [https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country-asn.mmdb.sha256sum](https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country-asn.mmdb.sha256sum)
...
geodata-mode: false
geox-url:
  mmdb: "https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/Country.mmdb"
  asn: "https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/GeoLite2-ASN.mmdb"
```
</details>
...
请查看本项目 `release` 分支下的 [srs 目录](https://github.com/asdetycv1zzc/geoip/tree/release/srs)。
  ...
  "rule_set": [
    {
      ...
      "type": "remote",
      "format": "binary",
      "url": "https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/srs/cn.srs"
    },
    {
      "tag": "geoip-us",
      "type": "remote",
      "format": "binary",
      "url": "https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/srs/us.srs"
    }
  ]
}
```
...
请查看本项目 `release` 分支下的 [mrs 目录](https://github.com/asdetycv1zzc/geoip/tree/release/mrs)。
...
rule-providers:
  cn-cidr:
    ...
    behavior: ipcidr
    format: mrs
    url: "https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/mrs/cn.mrs"
  ...
  google-cidr:
    ...
    behavior: ipcidr
    format: mrs
    url: "https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/mrs/google.mrs"
...
请查看本项目 `release` 分支下的 [clash 目录](https://github.com/asdetycv1zzc/geoip/tree/release/clash)。
...
rule-providers:
  cn-cidr:
    ...
    behavior: ipcidr
    format: yaml
    url: "https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/clash/ipcidr/cn.txt"
  ...
  telegram-cidr:
    ...
    behavior: ipcidr
    format: yaml
    url: "https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/clash/ipcidr/telegram.txt"
...
请查看本项目 `release` 分支下的 [surge 目录](https://github.com/asdetycv1zzc/geoip/tree/release/surge)。
...
```conf
[Rule]
RULE-SET,https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/surge/us.txt,REJECT
RULE-SET,https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/surge/cn.txt,DIRECT
RULE-SET,https://cdn.jsdelivr.net/gh/asdetycv1zzc/geoip@release/surge/telegram.txt,PROXY,no-resolve
```
</details>
...
请查看本项目 `release` 分支下的 [text 目录](https://github.com/asdetycv1zzc/geoip/tree/release/text)。

---

### Nginx `allow` 和 `deny` 文件

请查看本项目 `release` 分支下的 [nginx 目录](https://github.com/asdetycv1zzc/geoip/tree/release/nginx)。
...
- **在线生成**：[Fork](https://github.com/asdetycv1zzc/geoip/fork) 本仓库后，修改自己仓库内的配置文件 `config.json` 和 GitHub Workflow `.github/workflows/build.yml`
- **本地生成**：
  - 安装 [Golang](https://go.dev/dl/) 和 [Git](https://git-scm.com)
  - 拉取项目代码: `git clone https://github.com/asdetycv1zzc/geoip.git`
  - 进入项目根目录：`cd geoip`
  - 修改配置文件 `config.json`
...
- **在线生成**：[Fork](https://github.com/asdetycv1zzc/geoip/fork) 本项目后，如果需要使用 MaxMind GeoLite2 官方数据文件，需要在自己仓库的 **[Settings]** 页面的左侧边栏 **[Secrets and variables]** 下的 **[Actions]** 选项卡页面中添加一个名为 **MAXMIND_GEOLITE2_LICENSE** 的 secret，否则 GitHub Actions 会运行失败。这个 secret 的值为 MaxMind 账号的 LICENSE KEY，需要[**注册 MaxMind 账号**](https://www.maxmind.com/en/geolite2/signup)后，在[**个人账号管理页面**](https://www.maxmind.com/en/account)左侧边栏的 [**Manage License Keys**] 里生成。
- **本地生成**：如果需要使用 MaxMind 官方 GeoLite2 数据文件，需要提前从 MaxMind 下载，或者从本项目 [release 分支](https://github.com/asdetycv1zzc/geoip/tree/release)下载（文件名以 `GeoLite2` 为前缀的文件），并解压缩到名为 `geolite2` 的目录。
...
关于每种格式所支持的配置选项，查看本项目 [`configuration.md`](https://github.com/asdetycv1zzc/geoip/blob/HEAD/configuration.md) 文件。
...
可通过 `go install -v github.com/asdetycv1zzc/geoip@latest` 直接安装 CLI 工具。
...
- [@asdetycv1zzc/v2ray-rules-dat](https://github.com/asdetycv1zzc/v2ray-rules-dat)
- [@asdetycv1zzc/clash-rules](https://github.com/asdetycv1zzc/clash-rules)
- [@asdetycv1zzc/surge-rules](https://github.com/asdetycv1zzc/surge-rules)

## License

[CC-BY-SA-4.0](https://creativecommons.org/licenses/by-sa/4.0/) and [GPL-3.0](https://github.com/asdetycv1zzc/geoip/blob/master/LICENSE-GPL)

This product includes GeoLite2 data created by MaxMind, available from [MaxMind](https://www.maxmind.com).

## 项目 Star 数增长趋势

[![Stargazers over time](https://starchart.cc/asdetycv1zzc/geoip.svg)](https://starchart.cc/asdetycv1zzc/geoip)
